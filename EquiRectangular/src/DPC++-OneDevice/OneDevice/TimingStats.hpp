...
private:
	...
	std::chrono::duration<float> m_durationWarmup[TIMING_MAX];
	...
	std::chrono::duration<float> m_durationsSum[TIMING_MAX];
	...
	std::chrono::duration<float> m_lapDurationsSum[TIMING_MAX];
