...
def xyzpers(h_fov, v_fov, u, v, out_hw, in_rot):
    ...
    rotation_matrix_time = time.time()
    
    retVal = out.dot(Rx).dot(Ry).dot(Ri)
    
    out_dot_time = time.time()

    print("out_time time required = ", out_time - start_time)
    print("rotation_matrix_time time required = ", rotation_matrix_time - out_time)
    print("out_dot_time time required = ", out_dot_time - rotation_matrix_time)
