...
FOV = 60
window_width = 1080 # The height will be calculated to keep the 2 to 1 width / height ratio
...
while True:
  ...
  flatImg, XY = equ.GetPerspective(imgIndex, FOV, theta, phi, psi, height=window_width/2, width=window_width)
