...
private:
	...
	std::chrono::duration<float> m_durationWarmup[TIMING_MAX][ALL_STATS];
	...
	std::chrono::duration<float> m_durationsSum[TIMING_MAX][ALL_STATS];
	...
	std::chrono::duration<float> m_lapDurationsSum[TIMING_MAX][ALL_STATS];
