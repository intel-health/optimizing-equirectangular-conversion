...
wchar_t* pDpcppRemappingV2Name = _T("DpcppRemappingV2 Kernel");
__itt_string_handle* handle_DpcppRemappingV2_kernel = __itt_string_handle_create(pDpcppRemappingV2Name);
#endif
